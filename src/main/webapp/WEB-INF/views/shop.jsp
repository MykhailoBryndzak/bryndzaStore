...
<div class="panel">
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header"> Каталог продуктів </h2>
            </div>
        </div>
        <!-- Page Header -->
        ...
        <div class="col-md-2 sidebar" style="padding-right: 0px; padding-left: 0px;">
            <div class="list-group" id="searchBar">
                <a href="#" class="list-group-item active" id="All"><h4>Всі</h4></a>
                <a href="#" class="list-group-item" id="Fruit"><h4 id>Фрукти</h4></a>
                <a href="#" class="list-group-item" id="Drink"><h4>Напої</h4></a>
                <a href="#" class="list-group-item" id="Vegetables"><h4>Овочі</h4></a>
                <a href="#" class="list-group-item" id="Diary-products"><h4>Молочні продукти</h4></a>
                <a href="#" class="list-group-item" id="Chocolate"><h4>Шоколад</h4></a>
                <a href="#" class="list-group-item" id="Chips"><h4>Чіпси</h4></a>
            </div>
        </div>'
                                        ...
                                        <c:choose>
                                            <c:when test="${empty pageContext.request.userPrincipal}">
                                                <a data-toggle="modal" role="button" class="btn btn-default btn-block"
                                                   href="#login"> Додати продукти в корзину </a>
                                            </c:when>
                                            <c:otherwise>
                                                <a data-toggle="modal" role="button" class="btn btn-default btn-block"
                                                   href="#buy${item.itemID}"> Додати продукти в корзину </a>
                                            </c:otherwise>
                                        </c:choose>
